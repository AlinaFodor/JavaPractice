...
public class Masina {
    //oop mostenire=conceptul prin are o clasa mosteneste o alta clasa
    ...
    //acces control: private = disponibil doar in clasa unde este declarat
    //incapsulare =  prin care excludem atributele de tot ce le inconjoara
